...
import ru.svolf.core_ui.completefab.CompleteFABListener;
import ru.svolf.core_ui.completefab.CompleteFABView;
import ru.svolf.core_ui.listeners.FABProgressListener;
import ru.svolf.core_ui.progressarc.ArcListener;
import ru.svolf.core_ui.progressarc.ProgressArcView;
import ru.svolf.core_ui.utils.LibraryUtils;
...
public class FABProgressCircle extends FrameLayout implements ArcListener, CompleteFABListener {
  ...
  private void addArcView() {
    ...
    addView(progressArc,
        new LayoutParams(getFabDimension() + arcWidth, getFabDimension() + arcWidth,
            Gravity.CENTER));
  }
